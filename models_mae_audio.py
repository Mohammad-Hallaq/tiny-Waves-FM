            ...
            for index in range(16):
                ...
                decoder_modules.append(
                    SwinTransformerBlock(
                        input_resolution=(num_patches, embed_dim),
...
def mae_vit_base_patch16_dec512d8b(**kwargs):
    model = MaskedAutoencoderViT(
        ...
        decoder_embed_dim=512, decoder_num_heads=16,
        mlp_ratio=4, norm_layer=partial(nn.LayerNorm, eps=1e-6), decoder_mode=1,
        use_custom_patch=False, audio_exp=True, **kwargs)
    return model
...
def mae_vit_large_patch16_dec512d8b(**kwargs):
    model = MaskedAutoencoderViT(
        ...
        decoder_embed_dim=512, decoder_num_heads=16,
        mlp_ratio=4, norm_layer=partial(nn.LayerNorm, eps=1e-6), decoder_mode=1, **kwargs)
    return model
