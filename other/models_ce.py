...
class ChannelEstimationViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=2,
        ...
        self.decoder_pred = nn.Linear(decoder_embed_dim, self.n_subcarriers, bias=True)  # decoder to patch
        # --------------------------------------------------------------------------
    ...
    def forward(self, imgs):
        ...
        pred = self.forward_decoder(latent)[:, :2]
        return pred
...
def ce_vit_small_patch16_dec512d8b(**kwargs):
    model = ChannelEstimationViT(
...
def ce_vit_medium_patch16_dec512d8b(**kwargs):
    model = ChannelEstimationViT(
...
def ce_vit_large_patch16_dec512d8b(**kwargs):
    model = ChannelEstimationViT(
...
ce_vit_small_patch16 = ce_vit_small_patch16_dec512d8b  # decoder: 512 dim, 8 blocks
ce_vit_medium_patch16 = ce_vit_medium_patch16_dec512d8b  # decoder: 512 dim, 8 blocks
ce_vit_large_patch16 = ce_vit_large_patch16_dec512d8b  # decoder: 512 dim, 8 blocks
